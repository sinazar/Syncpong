...
- (IBAction)startAction:(id)sender
{
	if (true)
	{
		...
		[self.delegate hostViewController:self startGameWithSession:_matchmakingServer.session playerName:name clients:_matchmakingServer.connectedClients isHost:true];
	}
}
